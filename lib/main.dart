...
class _MainShellState extends State<MainShell> {
  ...
  Widget _screen() {
    switch (_i) {
      case 0: return const JournalScreen();
      case 1: return const HistoryScreen();
      case 2: return const WellbeingScreen();
      default: return const JournalScreen();
    }
  }
            ...
            child: Row(
              ...
              children: [
                _NavBtn(icon: Icons.home_outlined, activeIcon: Icons.home_rounded,
                  label: 'Home', active: _i == 0, onTap: () => setState(() => _i = 0)),
                _NavBtn(icon: Icons.history_outlined, activeIcon: Icons.history_rounded,
                  label: 'History', active: _i == 1, onTap: () => setState(() => _i = 1)),
                // Glowing purple center orb
                GestureDetector(
                  onTap: () => setState(() => _i = 0),
                  child: Container(
                    width: 52, height: 52,
...
class _NavBtn extends StatelessWidget {
  ...
  const _NavBtn({required this.icon, required this.activeIcon,
